...
作者：hanchao5272
来源：CSDN
原文：https://blog.csdn.net/hanchao5272/article/details/79780045
        ...
        public void run() {
            ...
            switch (type) {
                ...
                case 1:
                    ...
                    try {
                        //如果等待超时，则不再等待，回宿舍吃泡面
                        if (semaphore.tryAcquire(new Random().nextInt(10000)+6000, TimeUnit.MILLISECONDS)) {
                            //进行打饭
                            try {
                                Thread.sleep(new Random().nextInt(2000)+1000);
                            } catch (InterruptedException e) {
